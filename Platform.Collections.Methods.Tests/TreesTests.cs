...
namespace Platform.Collections.Methods.Tests
{
    public static class TreesTests
    {
        ...
        public static void MultipleAttachAndDetachTest()
        {
            ...
            sizeBalancedTree.TestMultipleRandomCreationsAndDeletions(sizeBalancedTree.Allocate, sizeBalancedTree.Free, ref sizeBalancedTree.Root, () => sizeBalancedTree.Count, 3);
