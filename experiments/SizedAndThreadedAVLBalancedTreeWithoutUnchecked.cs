...
{
    public class SizedAndThreadedAVLBalancedTreeWithoutUnchecked<TElement> : SizedAndThreadedAVLBalancedTreeMethodsWithoutUnchecked<TElement> where TElement: IUnsignedNumber<TElement>, IComparisonOperators<TElement, TElement, bool>
    {
        ...
        public SizedAndThreadedAVLBalancedTreeWithoutUnchecked(int capacity) => (_elements, _allocated) = (new TreeElement[capacity], TElement.One);
