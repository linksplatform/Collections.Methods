...
{
    /// <summary>
    /// Combination of Size, Height (AVL), and threads - Version WITHOUT unchecked blocks for performance comparison.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    public abstract class SizedAndThreadedAVLBalancedTreeMethodsWithoutUnchecked<TElement> : SizedBinaryTreeMethodsBase<TElement> where TElement: IUnsignedNumber<TElement>, IComparisonOperators<TElement, TElement, bool>
    {
        ...
        {
            // REMOVED unchecked block here - this is the key change for performance comparison
            ...
            while (true)
            {
                ...
                var isLeftNode = parent != default && (currentNode == GetLeft(parent));
        ...
        protected override void DetachCore(ref TElement root, TElement node)
        {
            ...
            if (balanceNode != default)
            {
                while (true)
                {
                    ...
                    isLeftNode = balanceParent != default && (balanceNode == GetLeft(balanceParent));
