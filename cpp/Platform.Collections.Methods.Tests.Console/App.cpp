...
int main()
{
    ...
    TestExtensions::TestMultipleCreationsAndDeletions(recursionlessSizeBalancedTree, [&]()-> std::size_t { return recursionlessSizeBalancedTree.Allocate(); }, [&](std::uint32_t link)-> auto { recursionlessSizeBalancedTree.Free(link); }, & recursionlessSizeBalancedTree.Root, [&]()-> std::size_t { return recursionlessSizeBalancedTree.Count(); }, _n);
    auto t2 = std::chrono::high_resolution_clock::now();
    auto duration1 = std::chrono::duration_cast<std::chrono::milliseconds>(t2 - t1).count();
    std::cout << duration1 << "ms (in order) for RecursionlessSizeBalancedTreeMethods\n";

    auto t3 = std::chrono::high_resolution_clock::now();
    TestExtensions::TestMultipleCreationsAndDeletions(sizeBalancedTree, [&]()-> std::size_t { return sizeBalancedTree.Allocate(); }, [&](std::uint32_t link)-> auto { sizeBalancedTree.Free(link); }, & sizeBalancedTree.Root, [&]()-> std::size_t { return sizeBalancedTree.Count(); }, _n);
    ...
    TestExtensions::TestMultipleCreationsAndDeletions(avlTree, [&]()-> std::size_t { return avlTree.Allocate(); }, [&](std::uint32_t link)-> auto { avlTree.Free(link); }, & avlTree.Root, [&]()-> std::size_t { return avlTree.Count(); }, _n);
    ...
    TestExtensions::TestMultipleRandomCreationsAndDeletions(recursionlessSizeBalancedTree, &recursionlessSizeBalancedTree.Root, [&]()-> std::size_t { return recursionlessSizeBalancedTree.Count(); }, _n);
    ...
    TestExtensions::TestMultipleRandomCreationsAndDeletions(sizeBalancedTree, &sizeBalancedTree.Root, [&]()-> std::size_t { return sizeBalancedTree.Count(); }, _n);
    ...
    TestExtensions::TestMultipleRandomCreationsAndDeletions(avlTree, &avlTree.Root, [&]()-> std::size_t { return avlTree.Count(); }, _n);
